                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="align-self-center mr-3">
                                                <div class="avatar">
                                                    <div class="default">
                                                        <a href="/users/{{ $follower->id }}/show">              
                                                            <img src="{{ asset('img/'. $follower->avatar) }}" class="mr-3" width="64">  
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="media-body py-3">
                                                <strong>
                                                    <a href="/users/{{ $follower->id }}/show">{{ $follower->first_name . $follower->last_name }}</a>
                                                </strong>
                                                <div class="float-right">
                                                    @if (auth()->user()->isFollowing($follower->id))
                                                        <a href="{{ route('user.unfollow', ['followed_id' => $follower->id]) }}" class="btn btn-danger">Unfollow</a>
                                                    @else
